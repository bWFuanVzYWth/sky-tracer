...
use crate::controls::{
    ...
    MAX_EXPOSURE_EV, MAX_HDR_PAPER_WHITE_NITS, MAX_HDR_PEAK_NITS, MAX_REINHARD_OVEREXPOSURE,
    MIN_EXPOSURE_EV, MIN_HDR_PAPER_WHITE_NITS, MIN_HDR_PEAK_NITS, MIN_REINHARD_OVEREXPOSURE,
    RealtimeControls,
};
...
impl WorkbenchState {
    pub fn new(asset: &RealtimeAsset) -> Self {
        ...
        Self {
            ...
            entries: if asset.is_default_view() {
                Vec::new()
            } else {
                vec![AssetEntry::from_path(current_path.clone(), &asset_root)]
            },
            current_path,
            asset_root,
            filter: String::new(),
                ...
                egui::ScrollArea::vertical()
                    ...
                    .show(ui, |ui| {
                        ...
                        if self.baked_atmosphere.is_some() {
                            ...
                            if asset.manifest().transport_version.as_deref()!=Some(sky_assets::asset::LAYERED_TRANSPORT_VERSION) {
                        ...
                        if self.hybrid_atmosphere {
                            ...
                            ui.label("Atmosphere and ground albedo belong to the baked reference. Re-bake to change them.");
                        }
                    });
            },
        );
