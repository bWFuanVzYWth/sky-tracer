...
use crate::{
    ...
    passes::{
        offline_lut::OfflineLutExperiment, unreal_atmosphere_8wave::UnrealAtmosphere8WaveExperiment,
    },
};
...
pub fn render(
    ...
    let gpu = sky_atmosphere_lut::solver::GpuBaker::new_with_features(
        sky_unreal_atmosphere_8wave::REQUIRED_FEATURES | benchmark_features,
    )
    ...
    let mut experiment: Box<dyn RealtimeExperiment> = match kind {
        ...
        crate::app::ExperimentKind::FourWave => Box::new(
        ...
        crate::app::ExperimentKind::Unreal8Wave => {
            Box::new(UnrealAtmosphere8WaveExperiment::new(init).map_err(std::io::Error::other)?)
        }
    };
    ...
    if linear {
        ...
        std::fs::write(
            ...
            serde_json::to_vec_pretty(&serde_json::json!({
                ...
                "medium_source":if matches!(kind, crate::app::ExperimentKind::Hybrid4d) {"data/ physical profiles; GPU startup solve; embedded four-wave calibration"} else {"experiment-specific"},"view_yaw_pitch_fov_exposure":view,
                ...
                "transport_version":sky_core::asset::LAYERED_TRANSPORT_VERSION
