...
use crate::physics::geometry::Planet;
use crate::physics::medium::{compute_majorant_grid, compute_majorants, rayleigh_cross_section_m2};
use crate::physics::phase::MiePhaseTable;
use crate::physics::spectrum::{BAND_COUNT, SpectralBand};
...
pub fn load_scene_data(
    ...
    let mut scene = SceneData {
        ...
        majorant_grid: crate::physics::atmosphere::MajorantGrid::new(120.0, 1, 1),
    };
    ...
    fn layered_majorants_dominate_extinction_samples() {
        ...
        for band in 0..BAND_COUNT {
            for i in 0..=240 {
                ...
                let pos = crate::physics::math::Vec3::new(
                    0.0,
                    scene.planet.ground_radius_km + altitude,
                    0.0,
                );
                let extinction =
                    crate::physics::medium::coefficients_at(&scene, pos, band).extinction_total();
...
/// This solver owns its source tables independently.
