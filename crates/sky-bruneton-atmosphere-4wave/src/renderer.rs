...
impl BrunetonAtmosphereContext {
    ...
    pub fn prepare(
        ...
        let gpu_params = bruneton_params(params);
    ...
    fn dispatch_precompute(&self, device: &wgpu::Device, encoder: &mut wgpu::CommandEncoder) {
        ...
        dispatch_compute_2d(
            ...
            &direct_irradiance_bind_group(
                ...
                DirectIrradianceBindGroupInput {
                    ...
                    delta_irradiance: &self.resources.delta_irradiance.view,
                },
            ),
            IRRADIANCE_SIZE,
        ...
        dispatch_compute_3d(
            ...
            &single_scattering_bind_group(
                ...
                SingleScatteringBindGroupInput {
                    ...
                    single_mie: &self.resources.single_mie.view,
        ...
        for order_buffer in &self.order_buffers {
            dispatch_compute_3d(
                ...
                &scattering_density_bind_group(
                    ...
                    ScatteringDensityBindGroupInput {
                        params: &self.params_buffer,
                        order: order_buffer,
                        irradiance: &self.resources.delta_irradiance.view,
                        scattering: &self.resources.scattering.view,
                        single_mie: &self.resources.single_mie.view,
                        delta_scattering: &self.resources.delta_scattering.view,
                        sampler: &self.sampler,
                        phase_lut: &self.resources.phase_lut.view,
            ...
            dispatch_compute_2d(
                ...
                &indirect_irradiance_bind_group(
                    ...
                    IndirectIrradianceBindGroupInput {
                        ...
                        irradiance: &self.resources.irradiance.view,
                        sampler: &self.sampler,
                        irradiance_out: &self.resources.irradiance_next.view,
                        delta_irradiance_out: &self.resources.delta_irradiance.view,
                        phase_lut: &self.resources.phase_lut.view,
                    },
                ),
                IRRADIANCE_SIZE,
            ...
            copy_texture_2d(
                encoder,
                &self.resources.irradiance_next.texture,
                &self.resources.irradiance.texture,
                IRRADIANCE_SIZE,
            );
            dispatch_compute_3d(
                encoder,
                ...
                &multiple_scattering_bind_group(
                    ...
                    MultipleScatteringBindGroupInput {
                        ...
                        sampler: &self.sampler,
                        delta_scattering: &self.resources.delta_scattering.view,
                        scattering_accum: &self.resources.scattering_next.view,
                    },
                ),
                SCATTERING_SIZE,
            ...
            copy_texture_3d(
                encoder,
                &self.resources.scattering_next.texture,
                &self.resources.scattering.texture,
                SCATTERING_SIZE,
            );
        }
    }
...
fn bruneton_params(params: &BrunetonFrameParams) -> HillaireParamsGpu {
    let atmosphere = params.atmosphere;
