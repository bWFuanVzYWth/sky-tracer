...
impl UnrealAtmosphereContext {
    pub fn new(gpu: &Gpu<'_>) -> Result<Self, UnrealRendererError> {
        ...
        let params_buffers = [
            uniform_buffer(
                device,
                "unreal.params.low.uniform",
                HillaireParamsGpu::zeroed(),
            ),
            uniform_buffer(
                device,
                "unreal.params.high.uniform",
                HillaireParamsGpu::zeroed(),
            ),
        ];
        ...
        dispatch_compute_2d(
            ...
            &ground_irradiance_bind_group(
                ...
                GroundIrradianceBindGroupInput {
                    ...
                    ground_irradiance: &resources.ground_irradiance.view,
...
fn unreal_params(params: &UnrealFrameParams, group: SpectralGroup) -> HillaireParamsGpu {
    let atmosphere = params.atmosphere;
