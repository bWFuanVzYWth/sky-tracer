...
/// Wavelength order used by the two 4-channel spectral GPU groups.
pub const SPECTRAL_GROUP_COUNT: usize = 2;
pub const SPECTRAL_SAMPLE_WAVELENGTHS_NM: [[f32; 4]; SPECTRAL_GROUP_COUNT] =
    [[410.0, 440.0, 480.0, 520.0], [540.0, 580.0, 610.0, 670.0]];
pub const SPECTRAL_QUADRATURE_WEIGHTS_NM: [[f32; 4]; SPECTRAL_GROUP_COUNT] = [
    [92.825735, 20.873265, 60.113315, 20.884022],
    [27.544867, 43.543118, 30.491347, 113.72433],
];
pub const SUN_SPECTRAL_IRRADIANCE: [[f32; 4]; SPECTRAL_GROUP_COUNT] = [
    [1.74773457, 1.76290144, 2.05664327, 1.81461108],
    [1.88470162, 1.85678685, 1.72942683, 1.53650429],
];
pub const MOLECULAR_SCATTERING_BASE: [[f32; 4]; SPECTRAL_GROUP_COUNT] = [
    [0.047815718, 0.036049181, 0.025453128, 0.018479607],
    [0.015890262, 0.01193972, 0.009758583, 0.006705125],
];
pub const OZONE_ABSORPTION_CROSS_SECTION: [[f32; 4]; SPECTRAL_GROUP_COUNT] = [
    [2.91e-27, 1.25e-26, 7.11e-26, 1.78e-25],
    [2.88e-25, 4.55e-25, 4.54e-25, 1.67e-25],
];
