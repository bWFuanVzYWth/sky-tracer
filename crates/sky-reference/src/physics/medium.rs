use crate::physics::atmosphere::MajorantGrid;
use crate::physics::atmosphere::{
    AerosolProfilePoint, AtmosphericProfilePoint, SPECIES_COUNT, SceneData,
};
use crate::physics::geometry::altitude_km;
...
mod tests {
    ...
    use crate::physics::spectrum::SpectralBand;
